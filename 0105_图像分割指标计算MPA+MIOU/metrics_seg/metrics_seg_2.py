...
if __name__ == '__main__':
    ...
    # 图片示例3 numclass = 4
    # imgPredict = Image.open("lin_pd/20210105_deeplabv3plus_resnet101_StepLR_Adam_temp/test_image11_pipeline_predict.png") # "lm_pd/image_1_predict.png"
    # imgPredict = np.array(imgPredict)
    # imgLabel = Image.open("tc_gt/image_11_label.png") # image_2_label
