...
def visual(lab_dir, img_dir, outdir):
    save_data_dir = os.path.join(outdir, "RGB_mid")
    ...
    for lab_path in lab_path_list:
        ...
        del lab
        img_name = os.path.basename(lab_path).split("_label")[0] + ".png"
...
if __name__ == "__main__":
    lab_dir = "../../../datasets/tianchi_jingwei/jingwei_round2_train_20190726/image_*label.png"  # 注意修改路径 jingwei_round2_train_20190726  jingwei_round1_train_20190619
    img_dir = "../../../datasets/tianchi_jingwei/jingwei_round2_train_20190726"  # 注意修改路径
