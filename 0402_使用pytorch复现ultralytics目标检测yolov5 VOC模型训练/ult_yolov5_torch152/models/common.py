...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
        ...
        self.act = nn.ReLU6() # nn.SiLU() if act is True else (act if isinstance(act, nn.Module) else nn.Identity()) # elesun
    # Sigmoid Tanh ReLU LeakyReLU PReLU ReLU6 RReLU SELU GELU SiLU  Swish? Mish?
    def forward(self, x):
