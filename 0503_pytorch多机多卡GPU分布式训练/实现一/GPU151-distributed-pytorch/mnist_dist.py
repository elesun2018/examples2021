...
# https://blog.csdn.net/weixin_36670529/article/details/104017291
...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=2500, metavar='N', # elesun 10
    ...
    parser.add_argument('--init-method', type=str, default='tcp://10.1.68.151:7477') # elesun
    parser.add_argument('--rank', type=int, default=0) # elesun
    parser.add_argument('--world-size', type=int, default=2) # elesun
