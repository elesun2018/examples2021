...
name_classes = ["farmland", "forest",  "grass", "road", "urban_area", "countryside","industrial_land", "construction",
                    "water", "bareland"]

calculation('gt_lishui_train','pd2_lishui_train', name_classes)#执行主函数 分别为 ‘ground truth’,'自己的实验分割结果'