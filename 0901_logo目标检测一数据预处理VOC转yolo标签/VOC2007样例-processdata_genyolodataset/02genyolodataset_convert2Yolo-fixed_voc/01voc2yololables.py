...
parser.add_argument('--in_img_path', default="../../../datasets/od/VOC2007/JPEGImages", type=str, help='directory of image folder')
parser.add_argument('--img_type', default=".jpg", type=str, help='type of image')
parser.add_argument('--in_label', default="../../../datasets/od/VOC2007/Annotations", type=str,
                    help='directory of label folder or label file path')
parser.add_argument('--in_cls_list_file', type=str, help='directory of *.names file', default="VOC2007.names")
parser.add_argument('--output_label_path', default="VOC2007yololabels", type=str, help='directory of label folder')
parser.add_argument('--output_manipast_path', type=str, help='path of manifast file', default="manifast_VOC2007.txt")
