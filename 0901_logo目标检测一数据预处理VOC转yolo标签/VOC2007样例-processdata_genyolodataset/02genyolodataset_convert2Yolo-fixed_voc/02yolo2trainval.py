...
if __name__=='__main__':
    time1 = time.time()
    in_label_dir = "VOC2007yololabels"
    in_image_dir = "../01processdata_genVOC/VOC2007/JPEGImages"
    in_set_dir = "../01processdata_genVOC/VOC2007/ImageSets/Main"
    out_label_dir = "VOC20072yolo/labels"
    out_image_dir = "VOC20072yolo/images"
