...
name_classes = ['motorbike', 'sofa', 'tvmonitor', 'chair', 'person', 'head', 'hand', 'foot', 'boat', 'horse', 'bottle', 'bird', 'bicycle', 'car', 'bus', 'pottedplant', 'train', 'dog', 'aeroplane', 'cat', 'diningtable', 'cow', 'sheep']
...
if __name__ == '__main__':
    img_path = "VOC20072yolo/images/trainval"
    label_path = "VOC20072yolo/labels/trainval"
    out_dir = "vis_output_2007"
    # 可视化数据集
