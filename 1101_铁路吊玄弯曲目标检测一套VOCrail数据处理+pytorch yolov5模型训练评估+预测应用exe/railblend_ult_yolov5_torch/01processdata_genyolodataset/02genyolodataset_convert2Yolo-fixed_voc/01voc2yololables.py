...
parser.add_argument('--in_img_path', default="../01processdata_genVOC/VOCrailblend/JPEGImages", type=str, help='directory of image folder')
parser.add_argument('--img_type', default=".jpg", type=str, help='type of image')
parser.add_argument('--in_label', default="../01processdata_genVOC/VOCrailblend/Annotations", type=str,
                    help='directory of label folder or label file path')
parser.add_argument('--in_cls_list_file', type=str, help='directory of *.names file', default="VOCrailblend.names")
parser.add_argument('--output_label_path', default="VOCrailblendyololabels", type=str, help='directory of label folder')
parser.add_argument('--output_manipast_path', type=str, help='path of manifast file', default="manifast_VOCrailblend.txt")
