...
if __name__=='__main__':
    time1 = time.time()
    in_label_dir = "VOCrailblendyololabels"
    in_image_dir = "../01processdata_genVOC/VOCrailblend/JPEGImages"
    in_set_dir = "../01processdata_genVOC/VOCrailblend/ImageSets/Main"
    out_label_dir = "VOCrailblend2yolo/labels"
    out_image_dir = "VOCrailblend2yolo/images"
