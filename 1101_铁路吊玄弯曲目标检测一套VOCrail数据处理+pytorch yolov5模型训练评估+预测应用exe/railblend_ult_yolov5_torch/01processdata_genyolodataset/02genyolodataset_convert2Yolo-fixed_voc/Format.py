...
class YOLO:
    ...
    def save(self, data, save_dir, img_path, img_type, manipast_path):
        if os.path.exists(save_dir):
            print(save_dir, "exist and delete")
        ...
        try:
            ...
            with open(os.path.abspath(manipast_path), "w") as manipast_file:
                ...
                for key in data:
                    ...
                    with open(os.path.abspath(os.path.join(save_dir, "".join([key, ".txt"]))), "w") as output_txt_file:
