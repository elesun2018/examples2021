...
parser.add_argument('--in_img_path', default="../01processdata_genVOC/VOClabel/JPEGImages", type=str, help='directory of image folder')
parser.add_argument('--img_type', default=".jpg", type=str, help='type of image')
parser.add_argument('--in_label', default="../01processdata_genVOC/VOClabel/Annotations", type=str,
                    help='directory of label folder or label file path')
parser.add_argument('--in_cls_list_file', type=str, help='directory of *.names file', default="VOClabel.names")
parser.add_argument('--output_label_path', default="VOClabelyololabels", type=str, help='directory of label folder')
parser.add_argument('--output_manipast_path', type=str, help='path of manifast file', default="manifast_VOClabel.txt")
