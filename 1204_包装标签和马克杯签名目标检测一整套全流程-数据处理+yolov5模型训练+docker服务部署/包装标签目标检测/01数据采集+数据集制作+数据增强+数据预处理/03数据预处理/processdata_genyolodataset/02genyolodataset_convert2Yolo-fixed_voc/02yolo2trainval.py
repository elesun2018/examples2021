...
if __name__=='__main__':
    time1 = time.time()
    in_label_dir = "VOClabelyololabels"
    in_image_dir = "../01processdata_genVOC/VOClabel/JPEGImages"
    in_set_dir = "../01processdata_genVOC/VOClabel/ImageSets/Main"
    out_label_dir = "VOClabel2yolo/labels"
    out_image_dir = "VOClabel2yolo/images"
