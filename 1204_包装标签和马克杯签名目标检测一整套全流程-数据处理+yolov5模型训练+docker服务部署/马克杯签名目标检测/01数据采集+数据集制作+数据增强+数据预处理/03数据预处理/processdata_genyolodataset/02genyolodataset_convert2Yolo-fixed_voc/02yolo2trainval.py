...
if __name__=='__main__':
    time1 = time.time()
    in_label_dir = "VOCmugyololabels"
    in_image_dir = "../01processdata_genVOC/VOCmug/JPEGImages"
    in_set_dir = "../01processdata_genVOC/VOCmug/ImageSets/Main"
    out_label_dir = "VOCmug2yolo/labels"
    out_image_dir = "VOCmug2yolo/images"
